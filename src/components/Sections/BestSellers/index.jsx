    ...
    <Wrapper>
      <WavesTop>
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <linearGradient id="MyGradientBottom" x1="0%" y1="0%" x2="100%" y2="0%">
            {/* <stop offset="0%" stopColor="rgb(240, 203, 200)" /> */}
            <stop offset="23%" stopColor="rgb(240, 203, 200)" />
            <stop offset="55%" stopColor="rgb(255, 255, 255)" />
